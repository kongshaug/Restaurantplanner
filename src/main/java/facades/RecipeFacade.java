...
public class RecipeFacade {
    ...
    public void addRecipe(String name, String directions, int preperationTime, Map<String, Integer> ingredience) {
        EntityManager em = emf.createEntityManager();
        Ingredient ingredient;
        Item item;
        Recipe recipe = new Recipe(name, preperationTime, directions);
        ...
        try {
            ...
            for (Map.Entry<String, Integer> entry : ingredience.entrySet()) {
                ...
                ingredient = new Ingredient(item, entry.getValue());
